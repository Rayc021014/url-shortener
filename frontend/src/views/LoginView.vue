  ...
  <div class="min-h-screen flex items-center justify-center px-4">
    <div class="w-full max-w-sm animate-fade-up">
      ...
      <div class="text-center mb-10">
        ...
        <h1 class="font-display font-bold text-3xl tracking-tight">Welcome back</h1>
        <p class="text-white/40 text-sm mt-2">Sign in to manage your links</p>
      </div>
      ...
      <p class="text-center text-sm text-white/35 mt-6">
        No account?
        <RouterLink to="/register" class="text-accent hover:text-accent-bright transition-colors">
          Create one
        </RouterLink>
      </p>
    </div>
